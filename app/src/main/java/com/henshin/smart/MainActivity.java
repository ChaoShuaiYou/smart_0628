...
public class MainActivity extends AppCompatActivity {
    ...
    private void showMap(Bundle savedInstanceState)
    {
        ...
        if (aMap == null) {
            ...
            aMap.moveCamera(CameraUpdateFactory.zoomTo(17)); //和 setPosition()方法冲突，只设置缩放大小时使用
        }
        ...
        BitmapDescriptor bitmapDescriptor_icon = BitmapDescriptorFactory.fromView(this.getLayoutInflater().inflate(R.layout.my_localtion,null));
